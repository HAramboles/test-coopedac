...
import { url_base, url_confirmar_transferencia_interbancaria } from './utils/dataPages/urls';
...
test.describe.serial('Pruebas con la Confirmacion de Transferencia Interbancaria', async () => {
    ...
    test('Ir a la opcion de Confirmar Transferencia Interbancaria', async () => {
        ...
        await expect(page).toHaveURL(`${url_confirmar_transferencia_interbancaria}`);
