...
import { url_base, selectBuscar, browserConfig, formComentario, formBuscar, contextConfig, actividadJuridicayRelacionado, actividadPersonaFisica, noData } from './utils/dataTests';
