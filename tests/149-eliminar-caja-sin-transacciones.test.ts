...
import { url_base, ariaCerrar, browserConfig, ariaAgregar, contextConfig, nombreTestigoCajero, userCorrecto, formBuscar, dataEliminar, noData } from './utils/dataTests';
