...
const nombreJuridica = 'AGRICOLAGROUP S.R.L';

// Nombre del relacionado
const nombreRelacionado = 'OSCAR';
const apellidoRelacionado = 'SMITH';

// Parametros para el Registro de Persona Juridica
interface RegistrarPersonaJuridica{
    ID_OPERACION: '3' | '1' | ''
};

const EscenariosPrueba: RegistrarPersonaJuridica[] = [
    {
        ID_OPERACION: ''
    },
    {
