...
import { dataFile, dataVer } from './utils/data/inputsButtons';
import { url_base, url_carta_atraso } from './utils/dataPages/urls';
...
test.describe.serial('Prueba con la Carta de Atraso', async () => {
    test.skip('No realizar el test de Carta de Atraso por su larga duracion de carga', async () => {
