...
import { selectBuscar, dataGuardar, dataEdit, dataEliminar, noData } from './utils/data/inputsButtons';
import { url_base, url_tabla_amortizacion } from './utils/dataPages/urls';
