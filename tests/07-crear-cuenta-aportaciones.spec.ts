...
// Parametros de la Creacion de cuenta de Aportaciones
interface CuentaAportaciones {
    REQUIERE_FIRMA_TITULAR: 'N' | 'S' | ''
    PERMITE_DEPOSITO_INICIAL: 'N' | 'S' | ''
};

const EscenariosPrueba: CuentaAportaciones[] = [
    {
...
test.describe('Creacion de Cuenta de Aportaciones - Pruebas con los diferentes parametros', () => {
    for (const escenario of EscenariosPrueba) {
        test.describe(`Test cuando el escenario es: ${Object.values(escenario).toString()}`, () => {
            test.beforeAll(async () => { // Antes de todas las pruebas
                ...
                // Eventos con la request de actividad_parametro
            ...
            if (escenario.PERMITE_DEPOSITO_INICIAL !== 'N' && escenario.REQUIERE_FIRMA_TITULAR !== 'N') {
                test('Parametros diferentes de N y N', async () => {
